    ...
    for (Opportunity opp : Trigger.new) {
        ...
        if (opp.Rate__c != null && opp.Rate__c >= 0) {
            ...
            if(amountString.contains('.')) {
                ...
                Integer decimalData = Integer.ValueOf(part2.substring(0,2));
                if(decimalData > 0) {
                    opp.Interest_Rate_In_Words__c +=' and '+Integer.ValueOf(part2.substring(0,2));
                }else {
                    opp.Interest_Rate_In_Words__c +=' and '+ 'No';
                }
            }
        } 
        else {
        ...
        if (opp.Broker_Fees__c != null && opp.Broker_Fees__c >= 0){
            ...
            if(amountString.contains('.')) {
                ...
                Integer decimalData = Integer.ValueOf(part2.substring(0,2));
                if(decimalData > 0) {
                    opp.Broker_Fees_In_Words__c +=' and '+Integer.ValueOf(part2.substring(0,2));
                }else {
                    opp.Broker_Fees_In_Words__c +=' and '+ 'No';
                }
            }
        } else {
        ...
        if (opp.CAF_Upfront_Fee__c != null && opp.CAF_Upfront_Fee__c >= 0){
            ...
            if(amountString.contains('.')) {
                ...
                Integer decimalData = Integer.ValueOf(part2.substring(0,2));
                if(decimalData > 0) {
                    opp.Origination_Fee_In_Words__c +=' and '+Integer.ValueOf(part2.substring(0,2));
                }else {
                    opp.Origination_Fee_In_Words__c +=' and '+ 'No';
                }
            }
        } else {
