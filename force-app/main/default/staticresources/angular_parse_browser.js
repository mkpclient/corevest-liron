    ...
    "+sqj2/": [
      function (require, module, exports) {
        ...
        var filters = function (filter) {
          ...
          f.formatCurrency = function (input) {
          ...
          f.addDays = function (input, days) {
            if (input && !$A.util.isEmpty(input)) {
              var date = new Date(input);
              date.setDate(date.getDate() + days);
              return $A.localizationService.formatDateUTC(date);
            } else {
              return input;
            }
          };

          f.addDaysFull = function (input, days) {
            if (input && !$A.util.isEmpty(input)) {
              var date = new Date(input);
              date.setDate(date.getDate() + days);
              return $A.localizationService.formatDateUTC(date, 'MMMM d, YYYY');
            } else {
              return input;
            }
          };
		  
		  f.upperCase = function (input) {
            if (input!= null && input!='') {
          ...
          f.formatDate = function (input) {
            if (input != null) {
              return $A.localizationService.formatDate(input, "MMMM d, YYYY");
            } else {
              return $A.localizationService.formatDate(
                new Date(),
                "MMMM d, YYYY"
          ...
          f.month = function (input) {
            if (input != null) {
              return $A.localizationService.formatDateUTC(input, "MMMM");
            } else {
              return $A.localizationService.formatDateUTC(new Date(), "MMMM");
            }
          };
          f.year = function (input) {
            if (input != null) {
              return $A.localizationService.formatDateUTC(input, "YYYY");
            } else {
              return $A.localizationService.formatDateUTC(new Date(), "YYYY");
            }
          };

          f.day = function (input) {
            if (input != null) {
              return $A.localizationService.formatDateUTC(input, "D");
            } else {
              return $A.localizationService.formatDateUTC(new Date(), "D");
            }
          };
        ...
        var Lexer = parse.Lexer,
          Parser = parse.Parser,
          lexer = new Lexer({}),
          parser = new Parser(lexer, filters);
