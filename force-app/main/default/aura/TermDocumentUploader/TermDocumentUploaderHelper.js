({
	...
	saveFile : function(component, file, index){
		return new Promise(function(resolve, reject) {
			...
			if(!file.uploaded && !$A.util.isEmpty(file.section) && !$A.util.isEmpty(file.documentType) ){

				if(component.get('v.uploadType') != 'bulk' || component.get('v.sobjectType') != 'Property__c'){
					$A.enqueueAction(action);
