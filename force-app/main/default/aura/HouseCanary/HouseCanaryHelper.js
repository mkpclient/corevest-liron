({
	...
	getTableData: function(component) {
		...
		let tableData = properties.map((prop) => ({
			...
			House_Canary_City__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 ? prop.Property_AVMs__r[0].AVM_C1_City__c : null,
			Diff_House_Canary_City__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 && prop.City__c && prop.City__c != prop.Property_AVMs__r[0].AVM_C1_City__c,
			...
			House_Canary_Beds__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 ? prop.Property_AVMs__r[0].AVM_Beds__c : null,
			Diff_House_Canary_Beds__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 && prop.Number_of_Beds__c && prop.Number_of_Beds__c != prop.Property_AVMs__r[0].AVM_Beds__c,
			House_Canary_Baths__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 ? prop.Property_AVMs__r[0].AVM_Baths__c : null,
			Diff_House_Canary_Baths__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 && prop.Number_of_Bath__c && prop.Number_of_Bath__c != prop.Property_AVMs__r[0].AVM_Baths__c,
			House_Canary_Square_Feet__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 ? prop.Property_AVMs__r[0].AVM_C1_Square_Feet__c : null,
			Diff_House_Canary_Square_Feet__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 && prop.Square_Feet__c && prop.Square_Feet__c != prop.Property_AVMs__r[0].AVM_C1_Square_Feet__c,
			House_Canary_Year_Built__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 ? prop.Property_AVMs__r[0].AVM_C1_Year_Built__c : null,
			Diff_House_Canary_Year_Built__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 && prop.Year_Built__c && prop.Year_Built__c != prop.Property_AVMs__r[0].AVM_C1_Year_Built__c,
			House_Canary_APN__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 ? prop.Property_AVMs__r[0].AVM_APN__c : null,
			Diff_House_Canary_APN__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 && prop.APN__c && prop.APN__c != prop.Property_AVMs__r[0].AVM_APN__c,
			House_Canary_Property_Type__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 ? prop.Property_AVMs__r[0].AVM_Property_Type__c : null,
			Diff_House_Canary_Property_Type__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 && prop.Property_Type__c && prop.Property_Type__c != prop.Property_AVMs__r[0].AVM_Property_Type__c,
			...
			Diff_House_Canary_Calculated_Price__c: prop.Property_AVMs__r && prop.Property_AVMs__r.length>0 && prop.Borrower_Opinion_of_Current_Value__c && prop.Borrower_Opinion_of_Current_Value__c != prop.Property_AVMs__r[0].AVM_Calculated_Price__c,
