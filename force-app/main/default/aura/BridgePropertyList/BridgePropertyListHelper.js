({
  ...
  compilePermissions: function (component) {
    let fields = ["Name", "Requested_Funding_Date__c", "Status__c", "Rehab_Budget__c", "Acquisition_Price__c",
      "After_Repair_Value__c", "Appraised_Value_Amount__c", "Reno_Advance_Amount__c", "Remedy_Plan__c", "Title_Company__c", "Title_Company_Contact__c", "Escrow_Agent__c", "Escrow_Company_Contact__c"];
